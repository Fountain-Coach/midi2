...
- Protocol: missing stream (mt=0xF) messages, function/group/terminal blocks, jitter reduction semantics wired to the scheduler, per-note pitch/pressure/timbre helpers, and MIDI 1.0 SysEx/down-conversion beyond channel voice.
