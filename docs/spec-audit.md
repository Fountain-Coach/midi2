...
| M2-104-UM v1.1.2 | Function Block Info Notification fields | 40 (Figure 22) | `Stream.FunctionBlockMessage` consumers | Pending | Direction bits: 0=reserved, 1=input-only, 2=output-only, 3=bidirectional; MIDI 1.0 bandwidth: 0=not MIDI1, 1=don't restrict, 2=restrict to 31.25 kbps, 3=reserved. Active flag indicates active/inactive. Needs enforcement in runtime decoding/tests. |
