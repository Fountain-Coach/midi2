...
| M2-103-UM v1.2 | Property Exchange JSON schema and chunking | TODO | `MidiCiPropertyExchangeBody`, PE schemas in JSON | Pending | Payload error/NAK behaviors still to align; status codes captured. |
